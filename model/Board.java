...
public final class Board extends Observable
{
  ...
  /*
   * I added this here as a constant that determines the addition to the score because 
   * I needed to add it into the clearLines method. Thought of you when I chose the number.
   */
  /** The amount that the score is incremented by. */
  private static final int SCORE_INCREMENT = 42;
  
  /*
   * I added this here as a constant that determines the next level because 
   * I needed to add it into the clearLines method.
   */
  /** The score that gets you to the next level. */
  private static final int LEVEL_INCREMENT = 420;
  
  /*
   * I added this here as a constant that determines the next delay because 
   * I needed to add it into the clearLines method.
   */
  /** The delay that increases the speed of the pieces. */
  private static final int DELAY_INCREMENT = 100;
  ...
  /*
   * I need to add the delay to increment it as the levels progress.
   */
  /**
   * The delay of this Tetris board.
   */
  private int my_delay;
  
  /*
   * I needed to add the score to increment it in the clearLines method.
   */
  /**
   * The score of the Tetris board.
   */
  private int my_score;
  
  /*
   * I needed to add the level to increment it in the clearLines method.
   */
  /**
   * The level of the Tetris board.
   */
                      ...
                      final List<MutablePiece> the_pieces)
  {
    ...
    /*
     * I added this hear to set the score to 1, the level to 0, and the delay to 100 
     * when the new game button is pressed.
     */
    my_score = 0;
    my_level = 1;
    my_delay = DELAY_INCREMENT;
  }
  ...
  /*
   * I couldn’t figure out a way to get the current location 
   * of each falling piece so I changed your Board class currentPieceMethod 
   * to public instead of private, making it possible for me to get the x and y coordinate 
   * of each piece. 
   */
  /**
  ...
  private void clearLines()
  {
    for (int i = my_blocks.size() - 1; i >= 0; i--)
    {
      ...
      if (clear)
      {
        ...
        /*
         *I added the score and level here to increment every time a line is cleared here 
         *to keep track of them as the game progresses.
         *I also added the delay to increment by 100 every time you get a new level.
         */
        my_score += SCORE_INCREMENT;
        if ((my_score % LEVEL_INCREMENT) == 0)
        {
          my_level++;
          my_delay += DELAY_INCREMENT;
        }
  ...
  /*
   * Here I added a method to return the current score of the game so I can add it into 
   * my board. I made it public so I can call it in my ScorePanel.
   */
  /**
   * Getter for the current score of the game.
   * 
   * @return my_score the score of the game
   */
  public int getScore()
  {
    return my_score;
  ...
  /*
   * Here I added a method to return the current level of the game so I can add it into 
   * my board. I made it public so I can call it in my ScorePanel.
   */
  /**
   * Getter for the current level of the game.
   * 
   * @return my_level the level of the game
   */
  public int getLevel()
  {
    return my_level;
  ...
  /*
   * Here I added a method to return the current delay of the game so I can add it into 
   * my board. I made it public so I can call it in my ScorePanel.
   */
  /**
   * Getter for the current delay of the game.
   * 
   * @return my_delay the delay of the game
   */
  public int getDelay()
  {
    return my_delay;
